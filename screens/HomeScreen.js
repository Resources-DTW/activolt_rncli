  ...
  return (
    <View className="flex-1 items-center justify-center px-5">
      <ScrollView showsVerticalScrollIndicator={false} className="py-8 mb-7">
        ...
        <View className="py-3">
          <View className="bg-white rounded-[10px] py-8 px-4 w-full">
            <Text
              style={{fontFamily: 'DMSans-Medium'}}
              className="text-[18px] text-[#222222]">
              SOC (%)
        ...
        <View className="py-3 flex-row items-center justify-between">
          <View className="flex-row items-center justify-between py-8 px-4 bg-white w-[48%] rounded-[10px]">
            <Text
              style={{fontFamily: 'DMSans-Medium'}}
              className="text-[14px] text-[#222222]">
              Error Code
        ...
        <View className="py-1 mb-4 flex-row items-center justify-between">
          ...
          <View className="flex-row items-center justify-between py-8 px-4 bg-white w-[48%] rounded-[10px]">
            ...
            <Svg
              ...
              fill="none">
              <Path
                d="M3.5 0.75L1.5 3.75L4.5 4.25L1 7.75"
                stroke="#00A66E"
        ...
        <View className="mb-6">
          <View className="bg-white w-full py-6 rounded-[10px] px-4 items-center justify-center">
            <Text
              style={{fontFamily: 'DMSans-Medium'}}
              className="text-[18px] text-[#222222]">
              Cell 2 Temperature
